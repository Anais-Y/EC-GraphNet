...
class trainer():
    def __init__(self, args, scaler, history, num_of_vertices,
                 ...
                 lr_decay=False, temporal_emb=True, spatial_emb=True, strides=3):
        """
        训练器
        :param args: 参数脚本
        :param scaler: 转换器
    ...
    def train(self, input, real_val):
        ...
        x shape:  (B1920, 8, 32, 4), y shape: (1920)
        :param input: B, T, N, C  input形式没变
        :param real_val: B
        real_val: B.
        ...
        return loss.item(), mae, mape, rmse, acc_all, acc_val
    ...
    def evel(self, input, real_val):
        ...
        acc_all = utils.accuracy(predict, real_val)['all']
        acc_val = utils.accuracy(predict, real_val)['valence']
        return mae, mape, rmse, acc_all, acc_val
